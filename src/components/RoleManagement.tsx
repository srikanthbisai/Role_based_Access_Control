        ...
        <table className="w-full border-collapse">
          <thead>
            <tr className="bg-gray-100 font-serif">
              <th className="py-2 px-2 sm:px-4 text-left text-sm sm:text-2xl">Role Name</th>
              <th className="py-2 px-2 sm:px-4 text-left text-sm sm:text-2xl hidden sm:table-cell">Permissions</th>
